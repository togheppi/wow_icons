...
class DatasetFromFolder(data.Dataset):
    def __init__(self, data_root, dataset, class_type, subfolder='train', transform=None, resize_scale=None, crop_size=None, fliplr=False):
        ...
        tag_fn = os.path.join(data_root, dataset) + '/' + class_type + '_label.pkl'
